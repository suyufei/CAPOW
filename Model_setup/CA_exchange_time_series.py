...
def exchange(year):
    ...
    #Path 42
    path_profiles = pd.read_excel('Path_setup/CA_path_export_profiles.xlsx',sheetname='Path42',header=None)
    ...
    #Path 24
    path_profiles = pd.read_excel('Path_setup/CA_path_export_profiles.xlsx',sheetname='Path24',header=None)
    pp = path_profiles.values
    ...
    #Path 45
    path_profiles = pd.read_excel('Path_setup/CA_path_export_profiles.xlsx',sheetname='Path45',header=None)
    pp = path_profiles.values
    ...
    #Path 66
    path_profiles = pd.read_excel('Path_setup/CA_path_export_profiles.xlsx',sheetname='Path66',header=None)
    pp = path_profiles.values
