...
MCD_fc = xlsread('PNW_hydro/FCRPS/res_specs2.xlsx','Mica_Daily','B4:K368');
...
for i = 1: sim_days
    ...
    %Evacuation mode
        ...
        s_3 = s_3 + local(i,3)*.001987 - LIB_dg;
    ...
    LIB_head = (LIB_forebay - LIB_tailwater)*.3048;
    generation(i,3) = ((1000*LIB_head*powerflow(i,3)*14.27641*9.81*.865)/1000000)*24;
...
% %nature spill
% NS=nature_spill(28835-1094:28835,:);
% AAA=transpose(sum(transpose(generation)));
% %AAB is for hydro validation
% AAB=AAA(28835-1094:28835);
% Sl=Storage_left(28835-1094:28835,1)*(1/.001987);
% BBB=transpose(sum(transpose(Modeled)));
% %AAB is for hydro validation
% ABB=BBB(28835-1094:28835);
% SH=Spillheads(28835-1094:28835,:);
% csvwrite('storageleft.csv',Sl);
% csvwrite('spillheads.csv',SH);
% VADIS=discharge(25186:28835,:);
% csvwrite('vali0708092.csv',AAB);
% csvwrite('naturespill.csv',NS);
% csvwrite('disvali.csv',VADIS);
% csvwrite('selectedhydro.csv',ABB);
